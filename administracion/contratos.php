...
?>
 ...
 ?>
        ...
        $hacerconsulta = $conexion->query($consulta);
                          ...
                          echo "<td align='center' bgcolor='#e8e8e8'><b><font color='black'>Inicio de Contrato</b></td>";
                          echo "<td align='center' bgcolor='#e8e8e8'><b><font color='black'>Fin de Contrato</b></td>";
                          echo "<td align='center' bgcolor='#e8e8e8'><b><font color='black'>Numero de Contrato</b></td>";
                          ...
                          <td  align='center' style='border: inset 0pt'>				
                            ...
                            <td  align='center' style='border: inset 0pt'>				
                              <form action='listaMaestra.php' method='post'>			
                                  ...
                                  <input type='submit' name='imageField' value='Lista Maestra'/>
                              </form>				
                          </td>
